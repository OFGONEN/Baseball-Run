...
#region Fields
		...
		[ Foldout( "UI Settings" ), Tooltip( "Cofactor of the movement for floating ui element" ) ] public float ui_Entity_FloatingMove_Cofactor;
		[ Foldout( "UI Settings" ), Tooltip( "Cofactor of the movement for floating ui element" ) ] public float ui_Entity_FloatingMove_Spawn_Cofactor;
